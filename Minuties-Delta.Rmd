...
```{r plot CSR, echo=FALSE, warning=FALSE, fig.height = 7.8, fig.width = 11.2}
CSR <- function(data,name, plot = TRUE, summary = TRUE){
  ...
  return c(CSR, cluster2, dispersed2)
...
print (datapouceD)
#CSR(pouceG,"PouceG") # 7
#CSR(propreD,"PropreD") # 29
#CSR(propreG,"PropreG") # 24
#CSR(controlD,"ControlD") # 69
#CSR(controlG,"ControlG") # 74
```
