...
print(new1) # print in nice format
```

djiodjvid

```{r plot CSR, echo=FALSE, warning=FALSE, fig.height=1.1, fig.width=4.29, fig.align="center"}
...
knitr::kable(datafin,format = "markdown",align=c("r","r","r","r"),caption = "Number of CSR patterns for each zone")

```

djiodjvid

```{r plot CSR 2, echo=FALSE, warning=FALSE, fig.height=1.1, fig.width=4.29, fig.align="center"}
...
knitr::kable(datafin2,format = "markdown",align=c("r","r","r","r"),caption = "Number of CSR patterns for each zone")
```
...
knitr::kable(datafin3,format = "markdown",align=c("r","r","r","r"),caption = "Number of CSR patterns for each zone")
```
...
knitr::kable(datafin4,format = "markdown",align=c("r","r","r","r"),caption = "Number of CSR patterns for each zone")
```

\blandscape


```{r angle, echo=FALSE, warning=FALSE, fig.height=1.1, fig.width=3.98, fig.align="center"}
...
```{r plot radar final, echo=FALSE, warning=FALSE, fig.height=4.3, fig.width=4.3, fig.align="center",fig.show="hold",fig.pos="H"}
dprod.angleb = as.data.frame(matrix(0,nrow=18,ncol=2)) ; dprog.angleb = as.data.frame(matrix(0,nrow=18,ncol=2))
dpoud.angleb = as.data.frame(matrix(0,nrow=18,ncol=2)) ; dpoug.angleb = as.data.frame(matrix(0,nrow=18,ncol=2))

for (i in 1:nrow(dprod.angle)) {dprod.angleb[i,] = cbind(sum(dprod.angle[i,4:21]), sum(dprod.angle[i,c(1:3,22:36)]))}
for (i in 1:nrow(dprog.angle)) {dprog.angleb[i,] = cbind(sum(dprog.angle[i,4:21]), sum(dprog.angle[i,c(1:3,22:36)]))}
for (i in 1:nrow(dpoud.angle)) {dpoud.angleb[i,] = cbind(sum(dpoud.angle[i,4:21]), sum(dpoud.angle[i,c(1:3,22:36)]))}
for (i in 1:nrow(dpoug.angle)) {dpoug.angleb[i,] = cbind(sum(dpoug.angle[i,4:21]), sum(dpoug.angle[i,c(1:3,22:36)]))}

knitr::kable(dprod.angleb,format = "markdown")
knitr::kable(dprog.angleb,format = "markdown")
knitr::kable(dpoud.angleb,format = "markdown")
knitr::kable(dpoug.angleb,format = "markdown")
```
\elandscape
\newpage
## Appendix
...
pdf("CSR Pouce droit.pdf",paper="a4r",width=11.2,height=7.8) ; CSR(pouceD,"PouceD",plot=T, summary=T) ; dev.off()
pdf("CSR Pouce gauche.pdf",paper="a4r",width=11.2,height=7.8) ; CSR(pouceG,"PouceG",plot=T, summary=T) ; dev.off()
pdf("CSR Propre droit.pdf",paper="a4r",width=11.2,height=7.8) ; CSR(propreD,"PropreD",plot=T, summary=T) ; dev.off()
pdf("CSR Propre gauche.pdf",paper="a4r",width=11.2,height=7.8) ; CSR(propreG,"PropreG",plot=T, summary=T) ; dev.off()
pdf("CSR Control droit.pdf",paper="a4r",width=11.2,height=7.8) ; CSR(controlD,"ControlD",plot=T, summary=T) ; dev.off()
pdf("CSR Control gauche.pdf",paper="a4r",width=11.2,height=7.8) ; CSR(controlG,"ControlG",plot=T, summary=T) ; dev.off()
```
